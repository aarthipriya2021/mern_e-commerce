...
export const signupAsync = createAsyncThunk('auth/signupAsync', async (cred) => await signup(cred))
export const loginAsync = createAsyncThunk('auth/loginAsync', async (cred) => await login(cred))
export const verifyOtpAsync = createAsyncThunk('auth/verifyOtpAsync', async (cred) => await verifyOtp(cred))
export const resendOtpAsync = createAsyncThunk('auth/resendOtpAsync', async (cred) => await resendOtp(cred))
export const forgotPasswordAsync = createAsyncThunk('auth/forgotPasswordAsync', async (cred) => await forgotPassword(cred))
export const resetPasswordAsync = createAsyncThunk('auth/resetPasswordAsync', async (cred) => await resetPassword(cred))
export const checkAuthAsync = createAsyncThunk('auth/checkAuthAsync', async () => await checkAuth())
export const logoutAsync = createAsyncThunk('auth/logoutAsync', async () => await logout())
